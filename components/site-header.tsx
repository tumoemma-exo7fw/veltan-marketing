    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-[#071c1e]/72 backdrop-blur-md">
        ...
        <div className="flex min-h-16 items-center justify-between gap-2 sm:gap-3">
          ...
          <div className="flex min-w-0 items-center justify-end gap-2 sm:gap-4 lg:gap-5">
            ...
            <div className="flex items-center justify-end gap-1.5 sm:gap-2">
              <Link
                href="/login"
                className="hidden min-h-11 items-center px-2.5 text-[13px] font-medium text-white/90 transition-colors hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-hero-cyan sm:text-[13.5px] lg:inline-flex"
              >
                Log in
              </Link>
              <WhatsAppCta
      ...
      <div className={menuOpen ? "lg:hidden" : "hidden"} id={menuId}>
          ...
          <div className="absolute inset-x-0 top-full z-50 max-h-[min(32rem,calc(100dvh-4rem))] overflow-y-auto border-b border-white/10 bg-[#071c1e]/96 shadow-lg backdrop-blur-md">
            ...
            />
            <div className="border-t border-white/10 px-4 py-3 sm:px-8">
              <Link
                href="/login"
                onClick={closeMenu}
                className="inline-flex min-h-12 w-full items-center justify-center rounded-full border border-white/15 text-[15px] font-medium text-white hover:bg-white/[0.06] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-hero-cyan"
              >
                Log in
              </Link>
            </div>
