/** Shared cinematic-dark classes so every section matches the homepage hero. */
export const glassPanel =
  "rounded-2xl border border-white/15 bg-[rgb(12_42_45/0.66)] shadow-[0_12px_40px_rgb(0_0_0/0.28)] backdrop-blur-md";

export const kicker =
  "text-[11px] font-semibold uppercase tracking-[0.28em] text-white/70";
